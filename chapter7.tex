...
\[ \tilde{a} \;\text{与}\; \identity_{L^{\otimes 2} \dotimes{K} N}, \quad \tilde{a}_{ji} \;\text{与}\; \identity_{L^{\otimes 3} \dotimes{K} N}, \]
...
\end{align*}
其中仍假设 $a(m) = \sum_{i=1}^n \ell_i \otimes m_i$. 这是从 \eqref{eqn:flat-descent-map-aux} 适当地缩并张量积的产物, 它至少具有更简洁的外观. 对 $\tilde{a}_{ji}$ 有类似的缩并版本, 不在话下.
