...
\vspace*{\stretch{1}}
\begin{center}
	\Huge \CJKfamily{coverfont}\textbf{代数学方法: 卷二 (草稿)}  \\ \vspace{0.7em}
\end{center}
%	\HRule
\vspace{1em}
\begin{center}\CJKfamily{cover-author-font}
...
%	%\draw[fill] ($(title.east)!.5!(volume.west)$) [right=1.5em] circle[radius=3pt]; 
